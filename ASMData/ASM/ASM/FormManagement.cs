...
namespace ASM
{
	public partial class FormManagement : Form
	{
		...
		{
			FormCustomers formCustomers = new FormCustomers(Employeerights);
			formCustomers.Show();
			this.Hide();
		}
		...
		{
			FormEmployees formEmployees = new FormEmployees(Employeerights);
			formEmployees.Show();
			this.Hide();
		}
		...
		{
			FormProduct formProduct = new FormProduct(Employeerights);
			formProduct.Show();
			this.Hide();
		}
		...
		{
			FormOrder formOrder = new FormOrder(Employeerights);
			formOrder.Show();
			this.Hide();
		}
		...
		private void btOrderDs_Click(object sender, EventArgs e)
		{
			...
			FormOrderDsetails formOrderDsetails = new FormOrderDsetails(Employeerights);
		...
		{
			FormStatistical formStatistical = new FormStatistical(Employeerights);
