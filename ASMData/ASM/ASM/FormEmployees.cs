...
namespace ASM
{
	public partial class FormEmployees : Form
	{
		...
		public FormEmployees(String employeerights)
		{
		...
		private void btSearchEe_Click(object sender, EventArgs e)
		{
			...
			using (SqlConnection con = new SqlConnection(@"Data Source=DESKTOP-708AVGT;Initial Catalog=ASM1;Integrated Security=True;TrustServerCertificate=True"))
			{
